...
public interface IArvoreBinaria<T> {
    ...
    /**
     * Metodo para adicionar um elemento à árvore.
    ...
    /**
     * Metodo para pesquisar por um elemento na árvore e retorná-lo.
    ...
    /**
     * Metodo para pesquisar por um elemento na árvore utilizando um comparator passado como parâmetro. Como o comparador a ser usado não é o que
    ...
    /**
     * Metodo que busca por um elemento na árvore e, caso encontre, o remove da árvore e o retorna
     * @param valor - será utilizado para passar o valor da chave a ser buscada. Por exemplo, se for um árvore de Alunos indexada por nome, deve-se passar um objeto do tipo aluno com o nome que se deseja buscar.
    ...
    /**
     * Metodo que retorna a quantidade de nós da árvore
    ...
    /**
     * Metodo que retona o resultado do caminhamento em nível na árvore.
    ...
    /**
     * Metodo que retona o resultado do caminhamento em ordem na árvore.
